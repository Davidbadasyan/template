...
/// sends messages to an exchange. Exchanges are message routing agents,
/// defined by the virtual host within RabbitMQ. An exchange is responsible
/// for routing the messages to different queues with the help of header attributes,
...
{
    const string BROKER_NAME = "esterno_event_bus";
    //const string AUTOFAC_SCOPE_NAME = "esterno_event_bus";
    ...
    private async Task ProcessEvent(string eventName, string message)
    {
        ...
        {
            await using var scope = _autofac.BeginLifetimeScope();
